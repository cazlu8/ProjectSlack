...
function pack_(tarball, folder, pkg, cb) {
  new Packer({ path: folder, type: "Directory", isDirectory: true }).on("error", function (er) {
...
function hasTarHeader(c) {
  return c[257] === 117 && // tar archives have 7573746172 at position
  c[258] === 115 && // 257 and 003030 or 202000 at position 262
  c[259] === 116 && c[260] === 97 && c[261] === 114 && (c[262] === 0 && c[263] === 48 && c[264] === 48 || c[262] === 32 && c[263] === 32 && c[264] === 0);
}

//# sourceMappingURL=tar-compiled.js.map