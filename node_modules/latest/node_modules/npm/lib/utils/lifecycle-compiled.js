...
function lifecycle(pkg, stage, wd, unsafe, failOk, cb) {
  ...
  validWd(wd || path.resolve(npm.dir, pkg.name), function (er, wd) {
    ...
    if ((wd.indexOf(npm.dir) !== 0 || path.basename(wd) !== pkg.name) && !unsafe && pkg.scripts[stage]) {
      log.warn("cannot run in wd", "%s %s (wd=%s)", pkg._id, pkg.scripts[stage], wd);
      return cb();
    }
...
function makeEnv(data, prefix, env) {
  ...
  if (!env) {
    ...
    Object.defineProperty(data, "_lifecycleEnv", { value: env,
      enumerable: false
    });
  }
...
//# sourceMappingURL=lifecycle-compiled.js.map