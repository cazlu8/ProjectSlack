...
function access(args, cb) {
  var cmd = args.shift();
  switch (cmd) {
    case "public":case "restricted":
      return changeAccess(args, cmd, cb);
    case "add":case "set":
      return add(args, cb);
    case "rm":case "del":case "clear":
      return rm(args, cb);
...
function changeAccess(args, level, cb) {
  ...
  assert(["public", "restricted"].indexOf(level) !== -1, "access level must be either 'public' or 'restricted'");
...
//# sourceMappingURL=access-compiled.js.map