...
function repo(args, cb) {
  ...
  fs.stat(n, function (er, s) {
    if (er && er.code === "ENOENT") return callRegistry(n, cb);else if (er) return cb(er);
...
function getUrlAndOpen(d, cb) {
  ...
  if (githubUserRepo(r.url)) r.url = githubUserRepo(r.url);
...
//# sourceMappingURL=repo-compiled.js.map