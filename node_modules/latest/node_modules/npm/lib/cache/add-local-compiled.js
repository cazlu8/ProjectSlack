...
function addLocalDirectory(p, pkgData, shasum, cb) {
  ...
  if (pathIsInside(p, npm.cache)) return cb(new Error("Adding a cache directory to the cache will make the world implode."));
...
//# sourceMappingURL=add-local-compiled.js.map