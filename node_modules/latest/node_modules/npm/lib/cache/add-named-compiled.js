...
function addNameVersion(name, v, data, cb) {
  ...
  function next() {
    ...
    if (!dist.tarball) return cb(new Error("No dist.tarball in " + data._id + " package"));
...
function addNameRange(name, range, data, cb) {
  ...
  if (range === null) return cb(new Error("Invalid version range: " + range));
...
//# sourceMappingURL=add-named-compiled.js.map