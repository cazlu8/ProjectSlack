...
exports['hook'] = {
  ...
  'pre-hook (simple syntax)': function preHookSimpleSyntax(test) {
    test.expect(3);
    // Pre-hook.
  ...
  'pre-hook': function preHook(test) {
    test.expect(3);
    // Pre-hook.
  ...
  'post-hook': function postHook(test) {
    test.expect(3);
    // Post-hook.
    var result = hooker.hook(this, 'add', {
      post: function post(result, a, b) {
  ...
  'pre- & post-hook': function prePostHook(test) {
    test.expect(2);
    // Pre- & post-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre-hook, return value override': function preHookReturnValueOverride(test) {
    test.expect(2);
    // Pre-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'post-hook, return value override': function postHookReturnValueOverride(test) {
    test.expect(2);
    // Post-hook.
    hooker.hook(this, 'add', {
      post: function post(result, a, b) {
  ...
  'pre- & post-hook, return value override': function prePostHookReturnValueOverride(test) {
    test.expect(2);
    // Pre- & post-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre-hook, filtering arguments': function preHookFilteringArguments(test) {
    test.expect(2);
    // Pre-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre- & post-hook, filtering arguments': function prePostHookFilteringArguments(test) {
    test.expect(2);
    // Pre- & post-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre- & post-hook, filtering arguments, return value override': function prePostHookFilteringArgumentsReturnValueOverride(test) {
    test.expect(2);
    // Pre- & post-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre-hook, preempt original function': function preHookPreemptOriginalFunction(test) {
    test.expect(2);
    // Pre-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre-hook, preempt original function with value': function preHookPreemptOriginalFunctionWithValue(test) {
    test.expect(2);
    // Pre-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre- & post-hook, preempt original function with value': function prePostHookPreemptOriginalFunctionWithValue(test) {
    test.expect(2);
    // Pre- & post-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre- & post-hook, preempt original function with value, return value override': function prePostHookPreemptOriginalFunctionWithValueReturnValueOverride(test) {
    test.expect(2);
    // Pre- & post-hook.
    hooker.hook(this, 'add', {
      pre: function pre(a, b) {
  ...
  'pre- & post-hook, some properties': function prePostHookSomeProperties(test) {
    test.expect(7);
    // Pre- & post-hook.
  ...
  'pre- & post-hook, all properties': function prePostHookAllProperties(test) {
    test.expect(7);
    // Pre- & post-hook.
  ...
  'pre- & post-hook, all properties, passName': function prePostHookAllPropertiesPassName(test) {
    test.expect(6);
    // Pre- & post-hook.
    hooker.hook(this.obj, {
      passName: true,
      pre: function pre(name, a, b) {
        // Arguments are passed into pre-hook as specified.
        this.that.track('before', this.prop, name, a, b);
      },
      post: function post(result, name, a, b) {
        // Arguments to post-hook are the original function's return value,
        // followed by the specified function arguments.
  ...
  'unhook one property': function unhookOneProperty(test) {
    test.expect(5);
    var orig = this.add;
    hooker.hook(this, 'add', function () {});
  ...
  'unhook some properties': function unhookSomeProperties(test) {
    test.expect(6);
  ...
  'unhook all properties': function unhookAllProperties(test) {
    test.expect(7);
    var add1 = this.obj.add1;
    var add2 = this.obj.add2;
...
//# sourceMappingURL=hooker_test-compiled.js.map