...
nodeunit.reporters.test = {
  run: function run(files, options, callback) {
    ...
    nodeunit.runFiles(paths, {
      ...
      moduleDone: function moduleDone(name) {
      ...
      testDone: function testDone(name, assertions) {
        delete unfinished[name];
        // Send back to the parent process.
        sendMessage({ testDone: [name.toString(), assertions.failures(), assertions.map(function (assertion) {
      ...
      done: function done(assertions) {
        // Send back to the parent process.
        sendMessage({ done: [assertions.failures(), assertions.duration, assertions] });
      }
    });
  }
};
...
//# sourceMappingURL=child-compiled.js.map