...
var _grep = which('grep') || process.platform === 'win32' && which('find');
...
exports['exit'] = {
  ...
  'grep': function grep(test) {
    ...
    test.ok(_grep, 'A suitable "grep" or "find" program was not found in the PATH.');
    test.done();
  } };
...
//# sourceMappingURL=exit_test-compiled.js.map