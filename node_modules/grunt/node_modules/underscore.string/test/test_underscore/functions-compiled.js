...
$(document).ready(function () {
  ...
  test("functions: bind", function () {
    ...
    var func = function func(salutation, firstname, lastname) {
  ...
  asyncTest("functions: delay", 2, function () {
    ...
    setTimeout(function () {
      ok(delayed, "delayed the function");start();
    }, 150);
  });
  ...
  asyncTest("functions: defer", 1, function () {
    ...
    _.delay(function () {
      ok(deferred, "deferred the function");start();
    }, 50);
  });
  ...
  asyncTest("functions: throttle", 2, function () {
    ...
    _.delay(function () {
      ok(counter == 4, "incr was throttled");start();
    }, 400);
  });
  ...
  asyncTest("functions: throttle arguments", 2, function () {
    ...
    _.delay(function () {
      equals(value, 6, "updated to latest value");start();
    }, 400);
  });
  ...
  asyncTest("functions: throttle once", 1, function () {
    ...
    throttledIncr();
    _.delay(function () {
      ok(counter == 1, "incr was called once");start();
    }, 220);
  });
  ...
  asyncTest("functions: throttle twice", 1, function () {
    ...
    _.delay(function () {
      ok(counter == 2, "incr was called twice");start();
    }, 220);
  });
  ...
  asyncTest("functions: debounce", 1, function () {
    ...
    _.delay(function () {
      ok(counter == 1, "incr was debounced");start();
    }, 220);
  });
  ...
  test("functions: compose", function () {
    ...
    var exclaim = function exclaim(sentence) {
      return sentence + "!";
    };
  ...
  test("functions: after", function () {
    var testAfter = function testAfter(afterAmount, timesCalled) {
      var afterCalled = 0;
