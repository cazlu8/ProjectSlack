...
$(document).ready(function () {
  ...
  test("objects: isEqual", function () {
    ...
    ok(!_.isEqual(new String("Curly"), { toString: function toString() {
        return "Curly";
    ...
    ok(!_.isEqual(new Number(63), { valueOf: function valueOf() {
        return 63;
    ...
    ok(!_.isEqual(1256450400000, new Date(2009, 9, 25)), "Dates and their corresponding numeric primitive values are not equal");
    ...
    var isEqualObj = { isEqual: function isEqual(o) {
    ...
    LocalizedString = (function () {
      function LocalizedString(id) {
        this.id = id;this.string = this.id === 10 ? "Bonjour" : "";
      }
      LocalizedString.prototype.isEqual = function (that) {
        if (_.isString(that)) return this.string == that;else if (that instanceof LocalizedString) return this.id == that.id;
        return false;
      };
  ...
  iDoc.write("<script>      parent.iElement   = document.createElement('div');      parent.iArguments = (function(){ return arguments; })(1, 2, 3);      parent.iArray     = [1, 2, 3];      parent.iString    = new String('hello');      parent.iNumber    = new Number(100);      parent.iFunction  = (function(){});      parent.iDate      = new Date();      parent.iRegExp    = /hi/;      parent.iNaN       = NaN;      parent.iNull      = null;      parent.iBoolean   = new Boolean(false);      parent.iUndefined = undefined;    </script>");
  iDoc.close();
  ...
  test("objects: tap", function () {
    ...
    var interceptor = function interceptor(obj) {
      intercepted = obj;
    };
