...
Type.Loader = function TypeLoader(options) {
  ...
  if ('string' !== this.kind && 'array' !== this.kind && 'object' !== this.kind) {
...
Type.Dumper = function TypeDumper(options) {
  ...
  if ('undefined' !== this.kind && 'null' !== this.kind && 'boolean' !== this.kind && 'integer' !== this.kind && 'float' !== this.kind && 'string' !== this.kind && 'array' !== this.kind && 'object' !== this.kind && 'function' !== this.kind) {
