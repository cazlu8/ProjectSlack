...
!(function (root, String) {
  ...
  var _s = {
    ...
    toSentence: function toSentence(array, separator, lastSeparator, serial) {
      separator = separator || ', ';
    ...
    surround: function surround(str, wrapper) {
      return [wrapper, str, wrapper].join('');
    },

    quote: function quote(str, quoteChar) {
      return _s.surround(str, quoteChar || '"');
    },

    unquote: function unquote(str, quoteChar) {
      quoteChar = quoteChar || '"';
    ...
    repeat: function repeat(str, qty, separator) {
      if (str == null) return '';
    ...
    levenshtein: function levenshtein(str1, str2) {
