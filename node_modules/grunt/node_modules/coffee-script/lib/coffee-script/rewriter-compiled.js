  ...
  exports.Rewriter = (function () {
    ...
    Rewriter.prototype.addImplicitBraces = function () {
      ...
      condition = function (token, i) {
        ...
        _ref = this.tokens.slice(i + 1, i + 3 + 1 || 9000000000), one = _ref[0], two = _ref[1], three = _ref[2];
    ...
    Rewriter.prototype.addImplicitParentheses = function () {
      ...
      return this.scanTokens(function (token, i, tokens) {
        ...
        _ref = tokens.slice(i - 1, i + 1 + 1 || 9000000000), prev = _ref[0], current = _ref[1], next = _ref[2];
...
//# sourceMappingURL=rewriter-compiled.js.map