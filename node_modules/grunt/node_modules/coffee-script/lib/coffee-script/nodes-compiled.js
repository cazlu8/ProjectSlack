...
(function () {
  ...
  Closure = {
    wrap: function wrap(expressions, statement, noReturn) {
    ...
    literalArgs: function literalArgs(node) {
      return node instanceof Literal && node.value === 'arguments' && !node.asKey;
    },
    literalThis: function literalThis(node) {
...
//# sourceMappingURL=nodes-compiled.js.map