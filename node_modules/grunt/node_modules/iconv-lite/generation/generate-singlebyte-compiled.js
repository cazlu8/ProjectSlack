...
var encodingFamilies = [{
    ...
    encodings: ["macCroatian", "macCyrillic", "macGreek", "macIceland", "macRoman", "macRomania", "macThai", "macTurkish", "macUkraine"] }, {
    // KOI8 code pages
...
encodingFamilies.forEach(function (family) {
    family.encodings.forEach(function (encoding) {
        ...
        if (encoding.aliases) encoding.aliases.forEach(function (alias) {
...
// Write encodings.
fs.writeFileSync("encodings/singlebyte.js", "module.exports = " + JSON.stringify(encodings, undefined, "  ") + ";");
...
//# sourceMappingURL=generate-singlebyte-compiled.js.map