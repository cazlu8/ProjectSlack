...
vows.describe('Generic UTF8-UCS2 tests').addBatch({
    ...
    'Internal encodings all correctly encoded/decoded': function InternalEncodingsAllCorrectlyEncodedDecoded() {
    ...
    'Base64 correctly encoded/decoded': function Base64CorrectlyEncodedDecoded() {
    ...
    'Latin1 correctly encoded/decoded': function Latin1CorrectlyEncodedDecoded() {
    ...
    'Convert from string, not buffer (binary encoding used)': function ConvertFromStringNotBufferBinaryEncodingUsed() {
        assert.strictEqual(iconv.fromEncoding(testStringLatin1, 'binary'), testStringLatin1);
    },
    'Convert to string, not buffer (utf8 used)': function ConvertToStringNotBufferUtf8Used() {
    ...
    'Throws on unknown encodings': function ThrowsOnUnknownEncodings() {
    ...
    'Convert non-strings and non-buffers': function ConvertNonStringsAndNonBuffers() {
    ...
    'Aliases encode and decode work the same as toEncoding and fromEncoding': function AliasesEncodeAndDecodeWorkTheSameAsToEncodingAndFromEncoding() {
...
//# sourceMappingURL=main-test-compiled.js.map