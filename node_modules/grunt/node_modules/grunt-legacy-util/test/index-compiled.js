...
exports['util.callbackify'] = {
  ...
  'callback (sync)': function callbackSync(test) {
    test.expect(1);
  ...
  'callback (async)': function callbackAsync(test) {
    test.expect(1);
...
exports['util'] = {
  ...
  'linefeed': function linefeed(test) {
    test.expect(1);
  ...
  'normalizelf': function normalizelf(test) {
    test.expect(1);
    if (process.platform === 'win32') {
...
exports['util.spawn'] = {
  ...
  'exit code 0': function exitCode0(test) {
    test.expect(6);
    util.spawn({
      cmd: process.execPath,
      args: [this.script, 0] }, function (err, result, code) {
  ...
  'exit code 0, fallback': function exitCode0Fallback(test) {
    test.expect(6);
    util.spawn({
      cmd: process.execPath,
      args: [this.script, 0],
  ...
  'non-zero exit code': function nonZeroExitCode(test) {
    test.expect(7);
    util.spawn({
      cmd: process.execPath,
      args: [this.script, 123] }, function (err, result, code) {
  ...
  'non-zero exit code, fallback': function nonZeroExitCodeFallback(test) {
    test.expect(6);
    util.spawn({
      cmd: process.execPath,
  ...
  'cmd not found': function cmdNotFound(test) {
    test.expect(3);
    util.spawn({
      cmd: 'nodewtfmisspelled' }, function (err, result, code) {
      test.ok(err instanceof Error);
  ...
  'cmd not found, fallback': function cmdNotFoundFallback(test) {
    test.expect(4);
    util.spawn({
  ...
  'cmd not in path': function cmdNotInPath(test) {
    test.expect(6);
    var win32 = process.platform === 'win32';
    util.spawn({
      cmd: 'test\\fixtures\\exec' + (win32 ? '.cmd' : '.sh') }, function (err, result, code) {
      test.equals(err, null);
      test.equals(code, 0);
  ...
  'cmd not in path (with cwd)': function cmdNotInPathWithCwd(test) {
    test.expect(6);
    var win32 = process.platform === 'win32';
    util.spawn({
      cmd: './exec' + (win32 ? '.cmd' : '.sh'),
      opts: { cwd: 'test/fixtures' } }, function (err, result, code) {
      test.equals(err, null);
      test.equals(code, 0);
      test.equals(result.stdout, 'done');
      test.equals(result.stderr, '');
  ...
  'grunt': function grunt(test) {
    test.expect(3);
    util.spawn({
      grunt: true,
      args: ['--gruntfile', 'test/fixtures/Gruntfile-print-text.js', 'print:foo'] }, function (err, result, code) {
      test.equals(err, null);
      test.equals(code, 0);
  ...
  'grunt (with cwd)': function gruntWithCwd(test) {
    test.expect(3);
    util.spawn({
      grunt: true,
  ...
  'grunt passes execArgv': function gruntPassesExecArgv(test) {
    test.expect(3);
    util.spawn({
      cmd: process.execPath,
      args: ['--harmony', process.argv[1], '--gruntfile', 'test/fixtures/Gruntfile-execArgv.js'] }, function (err, result, code) {
      test.equals(err, null);
      test.equals(code, 0);
  ...
  'grunt result.toString() with error': function gruntResultToStringWithError(test) {
  ...
  'custom stdio stream(s)': function customStdioStreamS(test) {
    test.expect(6);
    ...
    var child = util.spawn({
      cmd: process.execPath,
      args: [this.script, 0],
      opts: { stdio: [null, stdout, stderr] } }, function (err, result, code) {
      test.equals(code, 0);
...
exports['util.spawn.multibyte'] = {
  ...
  'partial stdout': function partialStdout(test) {
    test.expect(4);
    util.spawn({
      cmd: process.execPath,
      args: [this.script] }, function (err, result, code) {
      test.equals(err, null);
      test.equals(code, 0);
...
exports['util.recurse'] = {
  ...
  'primitives': function primitives(test) {
    test.expect(1);
    var actual = util.recurse({
      ...
      str: 'foo',
      nul: null,
      undef: undefined }, this.typeValue);
    var expected = {
  ...
  'array': function array(test) {
    test.expect(1);
    var actual = util.recurse({
      arr: [true, 1, 'foo', null, undefined, [true, 1, 'foo', null, undefined]] }, this.typeValue);
    var expected = {
      arr: [{ type: 'boolean', value: true }, { type: 'number', value: 1 }, { type: 'string', value: 'foo' }, { type: 'null', value: null }, { type: 'undefined', value: undefined }, [{ type: 'boolean', value: true }, { type: 'number', value: 1 }, { type: 'string', value: 'foo' }, { type: 'null', value: null }, { type: 'undefined', value: undefined }]] };
    test.deepEqual(actual, expected, 'Should recurse over arrays.');
    test.done();
  },
  'object': function object(test) {
    test.expect(1);
    var actual = util.recurse({
      obj: {
        bool: true,
  ...
  'array in object': function arrayInObject(test) {
    test.expect(1);
    var actual = util.recurse({
      obj: {
        arr: [true, 1, 'foo', null, undefined] } }, this.typeValue);
    var expected = {
      obj: {
        arr: [{ type: 'boolean', value: true }, { type: 'number', value: 1 }, { type: 'string', value: 'foo' }, { type: 'null', value: null }, { type: 'undefined', value: undefined }] } };
    test.deepEqual(actual, expected, 'Should recurse over arrays in objects.');
    test.done();
  },
  'object in array': function objectInArray(test) {
    test.expect(1);
    var actual = util.recurse({
      arr: [true, {
        num: 1,
        str: 'foo' }, null, undefined] }, this.typeValue);
    var expected = {
      arr: [{ type: 'boolean', value: true }, {
        num: { type: 'number', value: 1 },
        str: { type: 'string', value: 'foo' } }, { type: 'null', value: null }, { type: 'undefined', value: undefined }] };
    test.deepEqual(actual, expected, 'Should recurse over objects in arrays.');
    test.done();
  },
  'buffer': function buffer(test) {
    test.expect(1);
    var actual = util.recurse({
      buf: new Buffer('buf') }, this.typeValue);
    var expected = {
      buf: { type: 'buffer', value: new Buffer('buf') } };
    test.deepEqual(actual, expected, 'Should not mangle Buffer instances.');
    test.done();
  },
  'inherited properties': function inheritedProperties(test) {
    test.expect(1);
    var actual = util.recurse({
      obj: Object.create({ num: 1 }, {
        str: { value: 'foo', enumerable: true },
        ignored: { value: 'ignored', enumerable: false } }) }, this.typeValue);
    var expected = {
      obj: {
        num: { type: 'number', value: 1 },
        str: { type: 'string', value: 'foo' } }
  ...
  'circular references': function circularReferences(test) {
    test.expect(6);
    function assertErrorWithPath(expectedPath) {
      return function (actual) {
        return actual.path === expectedPath && actual.message === 'Circular reference detected (' + expectedPath + ')';
      };
    }
