...
var _sigmund = require('./sigmund.js');
...
exports.compare = {
  ...
  // },
  'JSON.stringify (guarded)': function JSONStringifyGuarded() {
    var seen = [];
  ...
  'noCommas 10': function noCommas10() {
    return noCommas(test, 10);
  },

  'sparse 10': function sparse10() {
    return sparse(test, 10);
  },

  'sparseFE 10': function sparseFE10() {
    return sparseFE(test, 10);
  },

  'sparseFE2 10': function sparseFE210() {
    return sparseFE2(test, 10);
  },

  sigmund: function sigmund() {
    return _sigmund(test, 10);
  } }
...
//# sourceMappingURL=bench-compiled.js.map