  ...
  */
	QUnit.jsDump = (function () {
		...
		var reName = /^function (\w+)/,
		    jsDump = {
			parse: function parse(obj, type, stack) {
			...
			typeOf: function typeOf(obj) {
				...
				// native arrays
				toString.call(obj) === "[object Array]" || typeof obj.length === "number" && typeof obj.item !== "undefined" && (obj.length ? obj.item(0) === obj[0] : obj.item(0) === null && typeof obj[0] === "undefined")) {
					type = "array";
				} else {
					type = typeof obj;
				}
