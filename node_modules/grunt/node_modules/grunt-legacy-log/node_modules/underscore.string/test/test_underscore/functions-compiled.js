...
$(document).ready(function () {
  ...
  asyncTest("throttle", 2, function () {
    ...
    _.delay(function () {
      equal(counter, 4, "incr was throttled");start();
    }, 400);
  });
  ...
  asyncTest("throttle arguments", 2, function () {
    ...
    _.delay(function () {
      equal(value, 6, "updated to latest value");start();
    }, 400);
  });
  ...
  asyncTest("throttle twice", 1, function () {
    ...
    _.delay(function () {
      equal(counter, 2, "incr was called twice");start();
    }, 220);
  });
  ...
  asyncTest("debounce", 1, function () {
    ...
    _.delay(function () {
      equal(counter, 1, "incr was debounced");start();
    }, 220);
  });
